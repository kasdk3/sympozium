...
1. **Issues** — Check [GitHub Issues](https://github.com/kasdk3/sympozium/issues) for open bugs, feature requests, and `good first issue` labels.
2. **Roadmap** — The project roadmap lives in [GitHub Projects](https://github.com/kasdk3/sympozium/projects). Pick items from the current milestone.
...
PRs must pass all checks before merging. On merge to `main`, images are automatically built and pushed to `ghcr.io/kasdk3/sympozium/`.
