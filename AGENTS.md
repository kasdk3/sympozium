...
for img in controller apiserver ipc-bridge webhook agent-runner web-proxy \
  ...
  kind load docker-image ghcr.io/kasdk3/sympozium/$img:v0.1.0 --name kind
done
...
kind load docker-image ghcr.io/kasdk3/sympozium/agent-runner:v0.1.0 --name kind
...
# Load into Kind
kind load docker-image ghcr.io/kasdk3/sympozium/<component>:v0.1.0 --name kind
