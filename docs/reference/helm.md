...
See [`charts/sympozium/values.yaml`](https://github.com/kasdk3/sympozium/blob/main/charts/sympozium/values.yaml) for all configuration options (replicas, resources, external NATS, network policies, etc.).
