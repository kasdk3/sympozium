...
spec:
    ...
    - name: open-pull-request
      ...
      content: |
        ...
        **Act on the results:**
        ...
        ---
        *Opened automatically by [Sympozium](https://github.com/kasdk3/sympozium)
        AgentRun: $AGENTRUN_NAME*
        EOF
        )" \
  ...
  sidecar:
    image: ghcr.io/kasdk3/sympozium/skill-github-gitops:latest
...
docker-build-skill-github-gitops:
	docker build -f images/skill-github-gitops/Dockerfile \
	  -t ghcr.io/kasdk3/sympozium/skill-github-gitops:$(TAG) .
```
