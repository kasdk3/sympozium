...
USE_CASE=""
TIMEOUT_SECONDS="180"
PROBE_IMAGE="${LLMFIT_PROBE_IMAGE:-ghcr.io/kasdk3/sympozium/skill-llmfit:latest}"
...
Options:
  ...
  --probe-image <image>  Image to run on each node (default: ghcr.io/kasdk3/sympozium/skill-llmfit:latest)
